                                                        ...
                                                        <td id="<?php echo e($val->type . '-' . $val->key); ?>">
                                                            <?php switch($val->type):
                                                                ...
                                                                <?php case ('multi_image'): ?>
                                                                    ...
                                                                    ?>
                                                                    <button class="btn btn-primary" onclick=""><i
                                                                            class="fa fa-plus"
                                                                            onclick="()=>{
                                                                            document.getElementById('<?php echo e($val->type . '-' . $val->key); ?>').innerHtml = '<input class='form-control'></input>'
                                                                        }"></i>
                                                                        New</button>
                                                                <?php break; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azfasa15/nginx/tefa-store/resources/views/settings/index.blade.php ENDPATH**/ ?>