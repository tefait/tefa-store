...
@section('container')
    ...
    <section class="flex gap-4 sm:ms-[270px] lg:ms-72 my-4 mb-8">
        <div class="w-full p-4 bg-white shadow-lg rounded-xl">
            <div class="flex justify-between items-center pb-4 mb-4 border-b">
                ...
                <button type="button" class="inline-flex gap-x-1 justify-center items-center py-3 px-4 h-9 text-sm font-medium text-center text-white bg-gradient-to-r rounded-3xl duration-300 from-secondary to-primary hover:bg-gradient-to-l" data-hs-overlay="#hs-scroll-modal-tambah-alamat">
    ...
    {{-- Modal Tambah Alamat --}}
    <div id="hs-scroll-modal-tambah-alamat" class="hs-overlay hidden size-full fixed top-0 start-0 z-[200] overflow-x-hidden overflow-y-auto pointer-events-none">
        ...
        <div class="max-h-full overflow-hidden flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
            ...
            <button type="button" class="flex  justify-center items-center size-7 text-sm font-semibold rounded-full border border-transparent text-gray-800 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:hover:bg-neutral-700" data-hs-overlay="#hs-scroll-modal-tambah-alamat">
    ...
    {{-- Modal Ubah Alamat --}}
    <div id="hs-scroll-modal-ubah-alamat" class="hs-overlay hidden size-full fixed top-0 start-0 z-[200] overflow-x-hidden overflow-y-auto pointer-events-none">
        <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-2xl sm:w-full m-3 sm:mx-auto h-[calc(100%-3.5rem)]">
        <div class="max-h-full overflow-hidden flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
            <div class="flex justify-between items-center py-3 px-4 border-b dark:border-neutral-700">
            <h3 class="font-bold text-gray-800 dark:text-white">
            ...
            <button type="button" class="flex justify-center items-center size-7 text-sm font-semibold rounded-full border border-transparent text-gray-800 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:hover:bg-neutral-700" data-hs-overlay="#hs-scroll-modal-ubah-alamat">
                <span class="sr-only">Close</span>
                <svg class="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M18 6 6 18"></path>
                <path d="m6 6 12 12"></path>
            ...
            <div class="flex justify-end items-center gap-x-2 py-3 px-4 border-t dark:border-neutral-700">
                <button type="button" class="inline-flex gap-x-3 justify-center items-center py-3 h-9 w-24 text-sm font-medium text-center bg-transparent rounded-3xl border duration-300 hover:bg-neutral-10 border-secondary text-secondary" data-hs-overlay="#hs-scroll-modal-ubah-alamat">
                    Batal
                </button>
                <button type="button" class="inline-flex gap-x-3 justify-center items-center py-3 h-9 w-24 text-sm font-medium text-center text-white bg-gradient-to-r rounded-3xl duration-300 from-secondary to-primary hover:from-primary hover:to-secondary">
                    Simpan
    ...
    {{-- Modal Hapus Alamat --}}
    <div id="hs-modal-hapus-alamat" class="hs-overlay hidden size-full fixed top-0 start-0 z-[200] overflow-x-hidden overflow-y-auto pointer-events-none">
        <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto min-h-[calc(100%-3.5rem)] flex items-center">
            <div class="relative w-full flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
                <div class="absolute top-4 end-4">
                    <button type="button" class="flex justify-center items-center size-7 text-sm font-semibold rounded-lg border border-transparent text-gray-800 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:border-transparent dark:hover:bg-neutral-700" data-hs-overlay="#hs-modal-hapus-alamat">
                    <span class="sr-only">Close</span>
                ...
                <div class="p-4 sm:p-6 text-center overflow-y-auto">
                    ...
                    <button type="button" class="flex-shrink-0" data-hs-overlay="#hs-modal-hapus-alamat">
                        <div class="py-2 px-4 w-44 text-xl text-red-500 border-[1.5px] border-red-500 bg-transparent hover:bg-red-50 rounded-full duration-300">
                            <p class="text-sm">Batal</p>
                        </div>
                    </button>
                    <button type="button" class="flex-shrink-0">
                        <div class="py-2 px-4 w-44 text-xl text-white border-[1.5px] border-red-500 bg-red-500 hover:text-red-500 hover:bg-transparent rounded-full duration-300">
