<div id="horizontal-scroll-tab-2" class="hidden" role="tabpanel" aria-labelledby="horizontal-scroll-tab-item-2">
    <!-- Card -->
    <div class="bg-green-50 border-s-4 border-green-500 rounded-xl mt-4 p-4 dark:bg-green-800/30" role="alert">
        <div class="flex gap-y-6 transition-all group size-full">
            ...
            <div class="flex justify-between w-full">
                <div>
                    ...
                    <p class="block text-sm font-semibold text-gray-800 dark:text-white">x2</p>
                    <span class="py-1.5 w-28 inline-flex justify-center items-center gap-x-1 text-xs font-bold bg-green-100 text-green-500 rounded-full dark:bg-green-500/10 dark:text-green-500">
                        Sudah dinilai
                    </span>
                </div>
                <div class="flex flex-col justify-between">
                    <div class="flex justify-end gap-1.5">
                        <div class="hs-tooltip">
                            <button type="button" class="flex-shrink-0" data-hs-overlay="#hs-detail-penilaian">
                                <!-- Icon -->
                    ...
                    <div>
                        <p class="block text-sm max-w-[20rem] truncate text-gray-800 dark:text-white">
                            Barangnya bagus banget kak, jangan ragu untuk beli disini
                        </p>
                    </div>
                </div>
            </div>
    ...
    <!-- End Card -->
    <!-- Card -->
    <div class="bg-red-50 border-s-4 border-red-500 rounded-xl mt-4 p-4 dark:bg-red-800/30" role="alert">
        <div class="flex gap-y-6 transition-all group size-full">
            <img src="{{ asset('storage/products/kaos_sm.jpg') }}" alt="" class="mr-3 h-24 rounded-lg">
            <div class="flex justify-between w-full">
                <div>
                    ...
                    <p class="block text-sm text-gray-500 dark:text-white">Putih, S</p>
                    <p class="block text-sm font-semibold text-gray-800 dark:text-white">x2</p>
                    <span class="py-1.5 w-28 inline-flex justify-center items-center gap-x-1 text-xs font-bold bg-red-100 text-red-500 rounded-full dark:bg-red-500/10 dark:text-red-500">
                        Belum dinilai
                    </span>
                </div>
                <div class="flex flex-col justify-between">
                    ...
                    <div class="">
                        <button type="button" class="flex-shrink-0" data-hs-overlay="#hs-beri-nilai">
                            <!-- Icon -->
                            <div class="py-2 px-4 w-44 text-xl text-red-600 border-[1.5px] border-red-600 bg-transparent hover:text-white hover:bg-red-600 rounded-full duration-300">
                                <p class="text-sm">Beri nilai</p>
                            </div>
                            <!-- End Icon -->
                        </button>
                    </div>
...
<div id="hs-detail-penilaian" class="hs-overlay hidden size-full fixed top-0 start-0 z-[200] overflow-x-hidden overflow-y-auto pointer-events-none">
    <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto min-h-[calc(100%-3.5rem)] flex items-center">
        <div class="w-full flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
            <div class="flex justify-between items-center py-3 px-4 border-b dark:border-neutral-700">
                ...
                <button type="button" class="flex justify-center items-center size-7 text-sm font-semibold rounded-full border border-transparent text-gray-800 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:hover:bg-neutral-700" data-hs-overlay="#hs-detail-penilaian">
            ...
            <div class="p-4">
                <div class="flex justify-between items-center">
                    ...
                    <div class="w-full">
                        <p class="text-sm text-end text-gray-500">2 hari yang lalu</p>
                    </div>
                </div>
...
{{-- End Modal Detail Penilaian --}}

{{-- Modal Beri Nilai --}}
<div id="hs-beri-nilai" class="hs-overlay hidden size-full fixed top-0 start-0 z-[200] overflow-x-hidden overflow-y-auto pointer-events-none">
    <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto min-h-[calc(100%-3.5rem)] flex items-center">
        <div class="w-full flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
            <div class="flex justify-between items-center py-3 px-4 border-b dark:border-neutral-700">
                <h3 class="font-bold text-gray-800 dark:text-white">
