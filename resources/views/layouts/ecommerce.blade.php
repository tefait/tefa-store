...
<body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container-fluid">
                    <a class="navbar-brand logo_h" href="{{ url('/') }}">
                        <img src="{{ cache('settings')['site-logo']['value'] }}" style="height: 2rem">
                    </a>
            ...
            <div class="row">
                <div class="col-lg-3  col-md-6 col-sm-6">
                    <div class="single-footer-widget">
                        ...
                        <p>
                            Tefa RPL SMKN 2 Sumedang adalah tempat siswa belajar dan berinovasi dalam bidang
                            Rekayasa
    ...
    {{-- <script src="/ecommerce/js/stellar.js"></script> --}}
    <script src="/ecommerce/js/jquery.ajaxchimp.min.js"></script>
    <script src="/ecommerce/vendors/counter-up/jquery.waypoints.min.js"></script>
    <script src="/ecommerce/vendors/flipclock/timer.js"></script>
    <script src="/ecommerce/js/mail-script.js"></script>
    <script src="/ecommerce/js/theme.js"></script>
