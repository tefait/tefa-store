...
<section class="grid lg:grid-cols-12 gap-x-8 gap-y-4 mt-4 lg:mt-6">
    ...
    <div class="flex flex-col col-span-5">
        <p class="font-semibold text-xl text-gray-800 dark:text-neutral-300">{{ $product->name }}</p>
        ...
        <p class="block mt-4 text-2xl font-bold text-gray-800 dark:text-white">Rp{{ number_format($product->price, 0, ',', '.') }}</p>
            ...
            <div class="flex flex-col gap-2 mt-1">
                ...
                <div class="inline-flex justify-center py-1 w-24 bg-white rounded-3xl border border-gray-300 dark:bg-neutral-900 dark:border-neutral-700" data-hs-input-number="">
                    <div class="flex gap-x-1.5 items-center">
                        ...
                        <input class="p-0 w-9 text-center text-gray-800 bg-transparent border-0 focus:ring-0 dark:text-white" type="text" value="1" data-hs-input-number-input="">
...
<section class="grid lg:grid-cols-12 gap-x-4 px-4 border divide-x rounded-xl">
    <div class="col-span-8">
        ...
        <div class="max-h-[700px] overflow-x-hidden [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
            <div>
        ...
        <div class="p-4 border-b">
            ...
            <!-- Ulasan Produk -->
            <div class="p-4 max-h-[420px] overflow-x-hidden [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
