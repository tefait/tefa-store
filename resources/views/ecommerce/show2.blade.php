...
@section('container')
    ...
    <section class="grid lg:grid-cols-12 gap-x-8 gap-y-4 mt-4 lg:mt-6">
        ...
        <div class="flex flex-col col-span-5">
            ...
            <p class="font-semibold text-xl text-gray-800 dark:text-neutral-300">{{ $product->name }}
            </p>
            ...
            <nav class="hidden gap-2 py-2 bg-white sm:flex">
                <button type="button"
                    class="inline-flex items-center gap-x-1.5 py-1.5 px-4 rounded-full text-sm font-medium border border-primary text-primary bg-blue-50 dark:border-neutral-200 dark:text-white">
                    Putih
                </button>
                <button type="button"
                    class="inline-flex items-center gap-x-1.5 py-1.5 px-4 rounded-full text-sm font-medium bg-gray-100 border border-gray-100 text-gray-800 dark:border-neutral-200 dark:text-white">
                    Hitam
                </button>
                <button type="button"
                    class="inline-flex items-center gap-x-1.5 py-1.5 px-4 rounded-full text-sm font-medium bg-gray-100 border border-gray-100 text-gray-800 dark:border-neutral-200 dark:text-white">
            ...
            <nav class="hidden gap-2 py-2 bg-white sm:flex">
                <button type="button"
                    class="inline-flex justify-center items-center gap-x-1.5 py-1.5 w-16 rounded-full text-sm font-medium border border-primary text-primary bg-blue-50 dark:border-neutral-200 dark:text-white">
                    S
                </button>
                <button type="button"
                    class="inline-flex justify-center items-center gap-x-1.5 py-1.5 w-16 rounded-full text-sm font-medium bg-gray-100 border border-gray-100 text-gray-800 dark:border-neutral-200 dark:text-white">
                    M
                </button>
                <button type="button"
                    class="inline-flex justify-center items-center gap-x-1.5 py-1.5 w-16 rounded-full text-sm font-medium bg-gray-100 border border-gray-100 text-gray-800 dark:border-neutral-200 dark:text-white">
    ...
    <section class="grid lg:grid-cols-12 gap-x-4 border-t divide-x">
        ...
        <div class="col-span-8">
            ...
            <div
                class="max-h-[700px] overflow-x-hidden
      ...
      dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
                ...
                <div id="horizontal-scroll-tab-3" class="hidden" role="tabpanel"
                ...
                <div id="horizontal-scroll-tab-4" class="hidden" role="tabpanel"
                ...
                <div id="horizontal-scroll-tab-5" class="hidden" role="tabpanel"
        ...
        <div class="col-span-4">
            ...
            <div class="p-4 border-b">
                <div class="flex justify-center items-center gap-2">
                    <svg class="flex-shrink-0 size-10 text-yellow-400 dark:text-yellow-600"
                ...
                @foreach ($product->testimonies as $comment)
                    <div class="border-b py-4">
                        ...
                        <div class="flex flex-col justify-center gap-2 mt-4">
                            ...
                            <div>
                                <p class="text-base text-gray-800"> {{ $comment->kutipan }}
                                </p>
                            </div>
                        </div>
                    </div>
