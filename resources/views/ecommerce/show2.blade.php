...
<section class="flex flex-col sm:grid sm:grid-cols-12 lg:gap-x-8 lg:gap-y-4 lg:mt-6">
    <div class="col-span-6 lg:col-span-4 w-[100vw] sm:w-auto">
        <div style="--swiper-pagination-color: #fff" class="swiper mySwiperDP2 h-96 w-full sm:h-[70%] sm:w-[88%] sm:rounded-xl">
        ...
        <div thumbsSlider="" class="swiper mySwiperDP hidden sm:block h-[18%] w-[88%] box-border pt-[10px] cursor-pointer">
            <div class="swiper-wrapper">
    ...
    <div class="flex flex-col col-span-6 lg:col-span-5 mt-3 px-4 sm:mt-0 sm:px-0">
        ...
        <div class="flex lg:hidden gap-3 mt-1">
            <p class="block text-2xl font-bold text-gray-800 dark:text-white">Rp{{ number_format($product->price, 0, ',', '.') }}</p>
            <div class="flex gap-1 items-center">
                <span class="line-through text-sm text-gray-400">
                    Rp{{ number_format($product->price, 0, ',', '.') }}
                </span>
                <span class="py-[1px] px-1.5 inline-flex items-centcacheer text-[12px] font-semibold bg-red-100 text-red-600 rounded-full dark:bg-red-500/10 dark:text-red-500">
                    33%
                </span>
            </div>
        </div>
        <div class="flex gap-1 items-center mt-1 text-sm text-gray-500">
            <svg class="flex-shrink-0 text-yellow-400 size-3.5 dark:text-yellow-600" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
        ...
        <span class="mt-2 py-1.5 w-28 inline-flex justify-center items-center gap-x-1 text-xs font-bold bg-teal-100 text-green-600 rounded-full dark:bg-teal-500/10 dark:text-green-500">
            <svg class="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round">
        ...
        <nav class="hidden gap-2 py-2 bg-white sm:flex">
            <button type="button" class="inline-flex items-center gap-x-1.5 py-1.5 px-4 rounded-full text-sm font-medium border border-primary text-primary bg-blue-50 dark:border-neutral-200 dark:text-white">Putih</button>
            <button type="button" class="inline-flex items-center gap-x-1.5 py-1.5 px-4 rounded-full text-sm font-medium bg-gray-100 border border-gray-100 text-gray-800 dark:border-neutral-200 dark:text-white">Hitam</button>
            <button type="button" class="inline-flex items-center gap-x-1.5 py-1.5 px-4 rounded-full text-sm font-medium bg-gray-100 border border-gray-100 text-gray-800 dark:border-neutral-200 dark:text-white">Abu-abu</button>
        </nav>
        ...
        <nav class="hidden gap-2 py-2 bg-white sm:flex">
            <button type="button" class="inline-flex justify-center items-center gap-x-1.5 py-1.5 w-16 rounded-full text-sm font-medium border border-primary text-primary bg-blue-50 dark:border-neutral-200 dark:text-white">S</button>
            <button type="button" class="inline-flex justify-center items-center gap-x-1.5 py-1.5 w-16 rounded-full text-sm font-medium bg-gray-100 border border-gray-100 text-gray-800 dark:border-neutral-200 dark:text-white">M</button>
            <button type="button" class="inline-flex justify-center items-center gap-x-1.5 py-1.5 w-16 rounded-full text-sm font-medium bg-gray-100 border border-gray-100 text-gray-800 dark:border-neutral-200 dark:text-white">L</button>
            <button type="button" class="inline-flex justify-center items-center gap-x-1.5 py-1.5 w-16 rounded-full text-sm font-medium bg-gray-100 border border-gray-100 text-gray-800 dark:border-neutral-200 dark:text-white">XL</button>
            <button type="button" class="inline-flex justify-center items-center gap-x-1.5 py-1.5 w-16 rounded-full text-sm font-medium bg-gray-100 border border-gray-100 text-gray-800 dark:border-neutral-200 dark:text-white">XXL</button>
        </nav>
    </div>

    <div class="lg:col-span-3 hidden lg:block">
        <form action="{{ route('front.cart') }}" method="POST" class="p-4 h-auto w-full bg-white border border-neutral-200 shadow-sm rounded-xl hover:shadow-md transition dark:bg-neutral-900 dark:border-neutral-800">
            @csrf
            ...
            <div class="flex flex-col gap-2 mt-1">
                ...
                <div class="inline-flex justify-center py-1 w-24 bg-white rounded-3xl border border-gray-300 dark:bg-neutral-900 dark:border-neutral-700" data-hs-input-number="">
                    <div class="flex gap-x-1.5 items-center">
                        ...
                        <input class="p-0 w-9 text-center text-gray-800 bg-transparent border-0 focus:ring-0 dark:text-white" type="text" value="1" data-hs-input-number-input="" name="qty">
            ...
            <div class="mt-4">
                <button type="submit" class="w-full py-1.5 px-auto inline-flex items-center justify-center gap-x-2 text-sm font-bold rounded-lg text-white bg-gradient-to-r from-secondary to-primary hover:bg-gradient-to-r hover:from-primary hover:to-secondary disabled:opacity-50 disabled:pointer-events-none duration-300">
...
<section class="sm:grid sm:grid-cols-12 lg:gap-x-4 px-4 mt-4 sm:px-0 sm:mt-0 border-y sm:divide-x lg:border lg:rounded-xl">
    <div class="sm:col-span-6 lg:col-span-8 lg:px-4 mb-2">
        ...
        <div class="max-h-[600px] lg:max-h-[700px] overflow-x-hidden [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
            <div>
    ...
    <div class="sm:col-span-6 lg:col-span-4">
        ...
        <div class="sm:ps-4">
            <div class="flex justify-center items-center gap-2 mt-3">
                <svg class="flex-shrink-0 size-7 sm:size-9 lg:size-10 text-yellow-400 dark:text-yellow-600" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                    <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"></path>
                </svg>
                <h3 class="text-4xl sm:text-6xl lg:text-7xl text-gray-800">4.9<span class="text-base text-gray-500">/5.0</span></h3>
            </div>
            ...
            <!-- Ulasan Produk -->
            <div class="pe-2 pt-4 sm:pt-0 sm:py-4 max-h-[320px] lg:max-h-[420px] overflow-x-hidden [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
...
<section class="my-8 px-4 lg:px-0">
    ...
    <div class="grid grid-cols-2 gap-2 sm:grid-cols-4 lg:grid-cols-6 lg:gap-4">
        @foreach ($products as $p)
            <a href="{{ route('front.show_product', $p->slug) }}" class="swiper-slide group flex justify-center h-[100%] w-[100%] mb-2">
                <div class="flex flex-col w-full h-full rounded-md shadow-sm group sm:shadow-md lg:rounded-lg">
                    ...
                    <div class="gap-1 px-1.5 pt-1 h-full text-start">
                        <p class="text-sm text-gray-600 dark:text-neutral-300 truncate-20-chars" style="max-width: 100%;">
                            {{ $p->name }}
                        </p>
