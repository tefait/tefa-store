...
<body>
    <div class="circlePosition w-[200px] h-[300px] bg-[#e14def] rounded-[100%] absolute z-0 top-20 start-60 blur-[150px]"></div>
    <div class="circlePosition w-[200px] h-[300px] bg-primary rounded-[100%] absolute z-0 bottom-0 end-60 blur-[150px]"></div>
    ...
    <div data-hs-stepper="">
        ...
        <section class="flex justify-center items-center w-[600px] my-4 mx-auto">
            <div class="w-full z-10 bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
                            ...
                            <div class="grid gap-y-4">
                                ...
                                <div>
                                    ...
                                    <label for="hs-icon-name"
                                        class="block text-sm font-medium mb-2 dark:text-white">Nama Lengkap</label>
                                    <div class="relative">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    ...
                                    <div>
                                        ...
                                        <label for="hs-icon-nomor"
                                            class="block text-sm font-medium mb-2 dark:text-white">Nomor HP</label>
                                        <div class="relative">
                                ...
                                <div>
                                    ...
                                    @enderror
                                    <label for="konfirmasi-password" class="block text-sm font-medium mb-2 dark:text-white">Konfirmasi Kata Sandi</label>
                                    <div class="relative">
                                        <input name="konfirmasi-password" type="password" id="hs-toggle-konfirmasi-password"
                                            class="py-3 px-4 ps-11 block w-full border border-gray-200 focus:border focus:border-primary shadow-sm rounded-lg text-sm disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 transition duration-300 ease-in-out"
        ...
        <section class="flex justify-center items-center w-[600px] my-4 mx-auto">
            <div class="w-full z-10 bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
                <div class="p-4 sm:p-7">
                    <div class="text-center">
                        <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Tambahkan Alamat</h1>
                    </div>
