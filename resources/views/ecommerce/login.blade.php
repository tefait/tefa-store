...
<body>
    <div class="circlePosition w-[150px] h-[250px] bg-primary rounded-[100%] absolute z-0 top-44 start-80 blur-[150px]"></div>
    <div class="circlePosition w-[150px] h-[250px] bg-[#e14def] rounded-[100%] absolute z-0 bottom-16 end-52 blur-[110px]"></div>
