...
<html lang="en">
    ...
    <body>
        ...
        <div
            class="circlePosition w-[150px] h-[250px] bg-primary rounded-[100%] absolute z-0 top-44 start-80 blur-[150px]">
        </div>
        <div
            class="circlePosition w-[150px] h-[250px] bg-[#e14def] rounded-[100%] absolute z-0 bottom-16 end-52 blur-[110px]">
        </div>
        ...
        <section class="flex justify-center items-center gap-12">
            <div class="flex">
                <img src="{{ asset('assets/img/overlay.png') }}" alt="" class="size-[400px] z-10">
            </div>
            <div class="flex items-center w-[400px] my-4">
                <div
                    ...
                    <div class="p-4 sm:p-7">
                        <div class="text-center">
                            ...
                            <p class="mt-2 text-sm text-gray-600 dark:text-neutral-400">
                                Belum punya akun?
                                <a class="text-primary dark:text-blue-500" href="{{ route('customer.register') }}">
                                    Daftar
                                </a>
                            </p>
                        </div>
                        ...
                        <div class="mt-5">
                                ...
                                <div class="grid gap-y-4">
                                    ...
                                    <div>
                                        <div class="flex justify-between">
                                            <label for="password" class="text-sm mb-2 dark:text-white">Kata
                                                Sandi</label>
                                            <a class="text-sm text-primary duration-300"
                                    ...
                                    <!-- End Form Group -->
                                    <button type="submit"
                                        class="w-full py-2 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium bg-gradient-to-r rounded-full from-secondary to-primary hover:from-primary hover:to-secondary text-white disabled:opacity-50 disabled:pointer-events-none">
                                        Masuk
                                    </button>
                                </div>
                            </form>
                            ...
                            <div
                                class="py-3 flex items-center text-xs text-gray-400 before:flex-1 before:border-t before:border-gray-200 before:me-6 after:flex-1 after:border-t after:border-gray-200 after:ms-6 dark:text-neutral-500 dark:before:border-neutral-600 dark:after:border-neutral-600">
                                Atau masuk dengan
                            </div>
