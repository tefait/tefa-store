...
@section('container')
<div class="flex py-50 mt-50 justify-center md:p-10 ">
    <div
        class="bg-white border md:p-5  shadow-sm rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
                ...
                <form method="POST" action="{{ route('customer.post_login') }}">
                    ...
                    <div class="grid gap-y-4">
                        ...
                        "target": "#hs-toggle-password"
                                    ...
                                    <svg class="flex-shrink-0 size-4 text-gray-400 dark:text-neutral-600" width="24"
                        ...
                        <!-- End Form Group -->
                        <button type="submit"
                            class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-base font-medium border border-transparent bg-gradient-to-r rounded-full from-secondary to-primary hover:from-primary hover:to-secondary text-white disabled:opacity-50 disabled:pointer-events-none">
                            Masuk
                        </button>
                    </div>
                </form>
