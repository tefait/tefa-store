          ...
          "tabsWrapperTemplate": "<div class=\"overflow-x-auto py-2 px-4 rounded-t-xl border-b border-gray-200 [&::-webkit-scrollbar]:h-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500 dark:bg-black dark:border-neutral-800\"></div>"
                ...
                <div class="relative p-4 border-b border-gray-200 dark:border-neutral-800">
                    <div class="relative">
                        ...
                        <input
                            class="py-3 ps-10 pe-4 block h-10 w-full border-gray-300 rounded-full text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-black dark:border-white dark:text-white dark:placeholder-gray-300 dark:focus:ring-neutral-600"
...
<nav class="sticky top-0 z-[199] w-full">
    <div
        class="hidden lg:flex items-center justify-between h-7 w-full px-6 sm:px-8 lg:px-10 bg-primary dark:bg-secondary">
        ...
        <div>
            ...
            <button type="button"
                class="hs-dark-mode hs-dark-mode-active:hidden inline-flex items-center gap-x-2 px-3 text-xs text-white text-opacity-80 hover:text-opacity-100"
                data-hs-theme-click-value="dark">
                <i class="bx bx-moon"></i>
                Dark
            </button>
            <button type="button"
                class="hs-dark-mode hs-dark-mode-active:inline-flex hidden items-center gap-x-2 px-3 text-xs text-white text-opacity-80 hover:text-opacity-100"
    ...
    <header
        ...
        <div class="relative w-full sm:flex sm:items-center sm:justify-between sm:px-4 lg:px-0" aria-label="Global">
            <div class="flex items-center justify-between w-full">
                <a href="/" class="flex-none text-xl font-semibold dark:text-white hidden sm:block"
                ...
                <div class="hidden lg:flex py-3 ml-5">
                    ...
                    <a href="{{ route('front.product') }}"
                        class="flex items-center justify-center w-24 text-sm text-gray-600 hover:text-black hover:bg-gray-100 duration-300 rounded-full py-1.5 px-2 font-medium dark:text-white">
                ...
                <div
                    class="flex flex-col gap-y-4 gap-x-0 sm:flex-row sm:items-center sm:justify-between sm:gap-y-0 sm:gap-x-5 sm:mx-5 mr-3 w-full">
                    <!-- SearchBox -->
                ...
                <div class="flex items-center gap-1">
                    <!-- Notification -->
                    <button type="button" class="relative inline-flex items-center text-sm font-medium"
                        data-hs-overlay="#hs-scroll-inside-body-modal">
                        <i
                            class="bx bx-bell text-2xl text-gray-800 dark:text-white hover:text-black py-1 px-2 rounded-full hover:bg-gray-100 dark:hover:bg-neutral-700 duration-300"></i>
                    ...
                    <button type="button" class="relative inline-flex items-center text-sm font-medium"
                        ...
                        <i
                            class="bx bx-cart text-2xl text-gray-800 dark:text-white hover:text-black py-1 px-2 rounded-full hover:bg-gray-100 dark:hover:bg-neutral-700 duration-300"></i>
                        <span class="flex absolute top-0 end-0 mt-0.5 me-[5px]">
                            <span class="relative inline-flex bg-red-500 text-white rounded-full py-[1px] px-[5px]"
                                style="font-size: 10px; line-height:14px;">
                                5
                    ...
                    <!-- Hamburger -->
                    <button type="button" class="lg:hidden relative inline-flex items-center text-sm font-medium"
                        data-hs-overlay="#hs-overlay-bottom" aria-label="Toggle Menu">
                        <i
                            class="bx bx-menu-alt-right text-2xl text-gray-800 dark:text-white hover:text-black py-1 px-2 rounded-full hover:bg-gray-100 dark:hover:bg-neutral-700 duration-300"></i>
                    </button>
                </div>
                ...
                <div class="">
                    <div id="navbar-collapse-with-animation"
                        class="lg:flex w-full hs-collapse hidden overflow-hidden transition-all duration-300">
                        <div class="flex justify-center gap-2">
                            <a class="inline-flex justify-center items-center h-9 gap-x-3 text-center bg-transparent hover:bg-neutral-10 duration-300 border border-secondary text-secondary text-sm font-medium rounded-3xl py-3 px-4"
                                href="{{ route('customer.login') }}">
                                Masuk
                            </a>
                            <a class="inline-flex justify-center items-center h-9 gap-x-3 text-center bg-gradient-to-r from-secondary to-primary hover:from-primary hover:to-secondary duration-300 text-white text-sm font-medium rounded-3xl py-3 px-5"
                                href="{{ route('register') }}">
                                Daftar
                            </a>
                        </div>
...
<div id="hs-scroll-inside-body-modal"
    ...
    <div
        ...
        <div
            class="max-h-full overflow-hidden flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-black dark:border-neutral-800 dark:shadow-neutral-700/70">
            ...
            <div class="p-0 overflow-y-auto divide-y dark:divide-neutral-800">
                <!-- Card -->
                <a href="#"
                    class="group flex items-center gap-y-6 gap-x-4 py-3 px-4 size-full hover:bg-gray-100 duration-300 transition-all dark:bg-black dark:hover:bg-neutral-900">
                    <div
                        class="inline-flex justify-center items-center py-1 px-2 rounded-full border-4 border-blue-50 bg-blue-100 dark:border-blue-700 dark:bg-blue-600">
            ...
            <div class="flex justify-end items-center py-1.5 px-4 border-t dark:border-neutral-800">
                <a href="#"
                    class="inline-flex items-center text-xs font-medium text-gray-800 hover:text-opacity-70 duration-300 dark:text-white dark:hover:text-opacity-70">
                    Lihat semua
...
<div id="hs-overlay-right"
    ...
    <div class="flex items-center justify-between border-b dark:border-neutral-800 max-w-full px-4 mb-4 h-9">
        ...
        <button type="submit"
            class="inline-flex items-center gap-x-2 text-xs font-semibold text-red-600 dark:text-red-500 hover:text-opacity-60 dark:hover:text-opacity-60 duration-300">
            Hapus semua
        </button>
    </div>
        ...
        <div class="group flex gap-y-6 p-4 size-full transition-all dark:bg-black">
            ...
            <div class="w-full">
                ...
                <div class="flex justify-between">
                    <!-- Input Number -->
                    <div class="py-1 px-1 mt-2 inline-block bg-white border border-gray-200 rounded-3xl dark:bg-neutral-900 dark:border-neutral-700"
                        data-hs-input-number="">
                        <div class="flex items-center gap-x-1.5">
                            <button type="button"
                                class="size-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-md text-gray-800 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800"
                            ...
                            <input
                                class="text-sm p-0 w-8 bg-transparent border-0 text-gray-800 text-center focus:ring-0 dark:text-white"
                    ...
                    <button class="flex items-center mt-2">
                        <i
                            class="bx bx-trash text-xl text-red-600 dark:text-red-500 hover:text-opacity-60 dark:hover:text-opacity-60 duration-300"></i>
                    </button>
                </div>
            </div>
        </div>
    ...
    <nav class="border-gray-200 fixed w-full z-20 bottom-0 start-0">
        <div
            class="flex items-center justify-between max-w-full px-4 rounded-t-lg bg-purple-100 border border-purple-600 h-10">
        ...
        <div class="flex items-center justify-between py-2 px-4 bg-white dark:bg-black">
            ...
            <form action="#" method="">
                @csrf
                <button type="submit"
                    class="inline-flex justify-center items-center h-9 gap-x-3 text-center bg-gradient-to-r from-secondary to-primary hover:from-primary hover:to-secondary duration-300 text-white text-sm font-semibold rounded-3xl py-5 px-7">
                    Beli (2)
                </button>
            </form>
        </div>
        ...
        <div class="flex flex-col bg-white pointer-events-auto max-w-full max-h-full h-full dark:bg-black">
            ...
            <div class="overflow-y-auto divide-y-8 divide-gray-100 dark:divide-neutral-900">
                ...
                <div class="flex justify-center pt-4 px-4 gap-2">
                    <a href="#"
                        class="inline-flex justify-center items-center h-9 w-full gap-x-3 text-center bg-transparent hover:bg-purple-100 duration-300 border border-secondary text-secondary text-sm font-medium rounded-3xl py-3 px-4">
                        Masuk
                    </a>
                    <a href="#"
                ...
                <div class="text-sm mt-4">
                    <a href="#"
                        class="flex items-center justify-between py-2 px-4 mt-2 hover:bg-gray-100 dark:hover:bg-neutral-900 duration-300">
                    ...
                    <a href="#"
                        class="flex items-center justify-between py-2 px-4 hover:bg-gray-100 dark:hover:bg-neutral-900 duration-300">
                        <span class="flex items-center gap-3 text-gray-800 dark:text-white">
                    ...
                    <a href="#"
                        class="flex items-center justify-between py-2 px-4 mb-2 hover:bg-gray-100 dark:hover:bg-neutral-900 duration-300">
                        <span class="flex items-center gap-3 text-gray-800 dark:text-white">
                ...
                <div class="text-sm">
                    <a href="#"
                        ...
                        <span class="flex items-center text-green-500 dark:text-green-400 text-xs">WhatsApp<i
                                class="bx bx-chevron-right text-2xl text-gray-400 dark:text-white"></i></span>
                    </a>
                    <a href="#"
                        class="flex items-center justify-between py-2 px-4 hover:bg-gray-100 dark:hover:bg-neutral-900 duration-300">
                        <span class="flex items-center gap-3 text-gray-800 dark:text-white">
