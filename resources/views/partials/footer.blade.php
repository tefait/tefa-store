...
<footer class="w-full max-w-[85rem] border-t mt-4 px-4 pt-4 lg:px-0 lg:py-10">
    <div class="flex justify-between">
      <div class="col-span-full hidden lg:col-span-1 lg:block w-1/3">
        <a class="flex-none text-xl font-semibold dark:text-white hidden lg:block" href="#" aria-label="Logo"><img src="{{cache('settings')['site-logo']['value'] }}" class="lg:h-12" alt="Logo Tefa PPLG"></a>
