                ...
                <a href="#" class="swiper-slide group flex justify-center h-[100%] w-[100%] mb-2">
                    <div class="group flex flex-col h-full w-full shadow-sm sm:shadow-md rounded-md lg:rounded-lg">
                        ...
                        <div class="pt-1 px-1.5 gap-1 text-start h-full">
                            ...
                            <p class="block font-bold text-gray-800 dark:text-white text-sm mt-1">Rp
                            ...
                            <div class="flex items-center mt-1 gap-1 text-xs text-gray-500">
                                <svg class="flex-shrink-0 size-3.5 text-yellow-400 dark:text-yellow-600"
    ...
    <footer class="sm:[270px] lg:ms-72 max-w-[85rem] border-t mt-4 px-4 pt-4 lg:px-0 lg:py-10">
        <div class="flex justify-between">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <div class="mt-3 grid space-y-2 lg:space-y-3 text-sm">
                        <span class="space-y-0.5">
                            ...
                            <h4><a href="#"
                                    class="text-sm font-semibold text-gray-900 hover:text-primary dark:text-neutral-100 dark:hover:text-primary duration-300">0878-9481-8815</a>
                            </h4>
                        </span>
                        <span class="space-y-0.5">
                            <p class="inline-flex gap-x-2 text-gray-600 dark:text-neutral-400">Email</p>
                            <h4><a href="#"
                                    class="text-sm font-semibold text-gray-900 hover:text-primary dark:text-neutral-100 dark:hover:text-primary duration-300">tefaitrpl@gmail.com
                            </h4>
                        </span>
                    </div>
                ...
                <div>
                    ...
                    <h4 class="mt-7 text-sm lg:text-base font-bold text-gray-900 uppercase dark:text-neutral-100">Ikuti
                        Kami</h4>
        ...
        <div
            ...
            <div class="flex flex-col py-2">
                ...
                <p class="mt-1 text-xs sm:text-sm text-gray-600 dark:text-neutral-400">© 2024 Tefa PPLG SMKN 2 Sumedang.
                </p>
            </div>
        </div>
    </footer>
